...
sys.path.append('/Users/linus/Desktop/slow-is-fast/manimgl_1.6.1/project_words/abide')
sys.path.append("/Users/linus/Desktop/slow-is-fast/manimgl_1.6.1/3b1b-linus-creatures")

from manimlib import *

from manim_imports_ext import *
from abide_text import image_paths, student_words, meaning_sentence_dict
...
class two(Scene):
    def construct(self):
        ...
        """
        Example sentence:：Tom and Jerry abide by each other's 
        agreement and have lived in peace ever since.【7:22】  
        7.8s
        """
        self.play(
        ...
        """
        Example sentence：Ronaldo cannot abide Messi having more Ballon 
        d'Ors than him, so Ronaldo continues to strive.【7:15】
        7.5s
        """
        self.play(
            *[Write(sent) for sent in sentence_gr],
