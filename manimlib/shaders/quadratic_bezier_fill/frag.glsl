...
From chatgpt:
Anti-Aliasing Width: The "width" in anti-aliasing width refers to the extent 
of the blending or smoothing effect applied to the edges of objects. A wider 
anti-aliasing width results in a more significant reduction of jaggedness but 
