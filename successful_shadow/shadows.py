...
class DefineDeterminant(Scene):
    def construct(self):
        ...
        det_name = Text("``Determinant''", font_size=36)
...
class SupposedlyObviousProportionality(ShadowScene):
    ...
    def construct(self):
        ...
        # "Obvious"
        obvious_words = Text("Isn't this obvious?", font_size=36)
...
class ByLine(Scene):
    def construct(self):
        lines = VGroup(
            Text("Artwork by\\\\", "Kurt Bruns"),
            Text("Music by\\\\", "Vince Rubinetti"),
            Text("Other stuff\\\\", "Grant Sanderson"),
        )
        for line in lines:
